...
var lengthOfTimeToBrainStorm = prompt("How long did you spend brain storming for the assignment? \n In minutes please.");
var lengthOfTimeToCode = prompt("How much time did you spend actually coding the assignment? \n In minutes please.");

//Variable to add up all of the time spent in minutes to do the assignment.
var totalTimeSpentOnAssignment  = Number(lengthOfTimeStudying) + Number(lengthOfTimeToBrainStorm) + Number(lengthOfTimeToCode);
...
var testArray = [lengthOfTimeToCode, lengthOfTimeToBrainStorm, lengthOfTimeStudying];
